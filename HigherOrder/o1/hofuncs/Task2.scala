...
object Task2 extends App {
  ...
  def vihruz(color: Color) = {
    Color(10 * color.red, 0, color.blue)
  }



  val scrambledPic = Pic("hidden1.png")
  val solvedPic = scrambledPic.transformColors(this.vihruz) // TODO: should use transformColors to reveal the hidden image
